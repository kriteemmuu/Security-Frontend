...
// Update Product API
export const updateProduct = (id, data) => Api.put(`/api/product/update_product/${id}`, data, config).catch(handleApiError);
...
// Add Item to Cart
export const addToCartApi = (data) => Api.post("/api/cart/add", data, config).catch(handleApiError);

// Get Cart Items
export const getCartItems = () => Api.get("/api/cart/get_cart_items", config).catch(handleApiError);

// Get Cart Items by User
export const getCartItemsApi = (userId) => Api.get(`/api/cart/get_cart_items?userId=${userId}`, config).catch(handleApiError);

// Review and Ratings
export const getReviewsApi = (productId) => Api.get(`/api/reviews/${productId}`).catch(handleApiError);
export const submitReviewApi = (data) => Api.post("/api/reviews", data, config).catch(handleApiError);
